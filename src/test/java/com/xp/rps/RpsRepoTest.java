...
public class RpsRepoTest {
    ...
    void oneRoundTest() {
        ...
        Round r1 = new Round(Throw.ROCK, Throw.PAPER);
        Round r2 = new Round(Throw.ROCK, Throw.PAPER);
        //Result
        r1.setResult(Result.P2_WINS);
        r2.setResult(Result.P2_WINS);
        ...
        assertEquals(Result.P2_WINS, g3.getResult(g3.getRoundList()));
    }
}
